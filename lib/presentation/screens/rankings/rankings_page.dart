...
class _RankingsPageState extends State<RankingsPage> {
  ...
  Widget _buildTopBar() {
    // Mirror GlobalAppBar (Common_header_withlogo.dart) exactly: same
    // logo size, "BeTrade™" wordmark (#1A0D2B / white), and bell chip.
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final textColor = isDark ? Colors.white : const Color(0xFF1A0D2B);
    return Padding(
      padding: EdgeInsets.fromLTRB(16.w, 10.h, 16.w, 12.h),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
