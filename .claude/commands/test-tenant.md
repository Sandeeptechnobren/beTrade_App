...
If this is **NOT** a multi-tenant project, report that and skip. (Note: this Flutter mobile client has no multi-tenancy concept on the device — tenancy lives on the backend, which is outside this repo.)
