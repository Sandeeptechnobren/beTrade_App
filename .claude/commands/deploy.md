...
> **Project note**: This is a Flutter mobile app — there is currently **no deploy target**. Distribution today means producing signed binaries (APK/AAB/IPA) locally. This command applies once a build server or backend host is added. Until then, the SSH pre-check will fail and stop here.
