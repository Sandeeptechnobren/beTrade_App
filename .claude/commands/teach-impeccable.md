...
---
I need to learn about this project's design language so all future `/audit`, `/polish`, `/critique` commands are project-aware. Interview me with these questions one at a time using `AskUserQuestion`:
...
After gathering answers, save them to `.claude/skills/frontend-design/brand-context.md` in this format:
