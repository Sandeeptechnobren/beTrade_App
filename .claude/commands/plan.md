...
9. **BROAD OPERATION CHECK**: If this task involves rename/refactor touching 5+ files, run `grep` first to find all occurrences. Include the EXACT file list in the plan. Flag any files in protected directories (`.claude/skills/`, `node_modules/`, `.git/`, `dist/`, `build/`, `.dart_tool/`). The plan is INCOMPLETE without this list.
